...
//#region node_modules/.nitro/vite/services/ssr/assets/router-ZwV2cJLW.js
var router_ZwV2cJLW_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Br7ah5tX.css";
var APP_NAME = "梅窩換樓";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "梅窩租售盤聚合 · 村屋 700 呎、買盤 $400萬以下超過 400 呎，唔要居屋。"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-CkVEwaxA.mjs");
...
//#endregion
export { getRouter, router_ZwV2cJLW_exports as t };
