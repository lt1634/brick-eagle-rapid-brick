...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Mx6C_chs.mjs");
...
var manifest = { "929d99346060014174612d544a0d0a34212a29a2a0c126d9dfba285ad0d1b8c1": {
	functionName: "loadListings_createServerFn_handler",
	importer: () => import("./functions-DJw2o9e8.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-ZwV2cJLW.mjs").then((n) => n.t),
